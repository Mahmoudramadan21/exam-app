...
import { IExamSortable, ISortOption } from "@/shared/lib/types/sort-option";

interface IExamSortHeaderProps {
  sortOptions: ISortOption<IExamSortable>[];
}

export default function ExamSortHeader({ sortOptions }: IExamSortHeaderProps) {
